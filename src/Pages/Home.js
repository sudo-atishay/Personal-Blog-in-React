...
function Home() {
  return (
    <div style={{ background: "#fff", color: "#111", minHeight: "100vh", fontFamily: "Arial, sans-serif", padding: "0", margin: "0" }}>
      <div style={{ maxWidth: 800, margin: "40px auto", padding: "32px", boxShadow: "0 2px 16px rgba(0,0,0,0.06)", borderRadius: 12 }}>
        {/* Profile Image & Name */}
        <div style={{ display: "flex", alignItems: "center", gap: 32, marginBottom: 32 }}>
          ...
          <div>
            <h1 style={{ fontSize: 32, margin: "0 0 8px 0" }}>Atishay Jain</h1>
            <h2 style={{ fontSize: 20, fontWeight: "normal", margin: "0 0 12px 0", color: "#444" }}>Software Developer | 3+ Years Experience</h2>
        ...
        <section style={{ marginBottom: 32 }}>
          <h3 style={{ fontSize: 22, marginBottom: 8 }}>About Me</h3>
        ...
        {/* Education */}
        <section style={{ marginBottom: 32 }}>
          <h3 style={{ fontSize: 22, marginBottom: 8 }}>Education</h3>
        ...
        {/* Experience */}
        <section>
          <h3 style={{ fontSize: 22, marginBottom: 8 }}>Experience</h3>
          <ul style={{ fontSize: 16, color: "#222", margin: 0, padding: 0 }}>
